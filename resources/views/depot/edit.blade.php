...
<div class="card col-md-8">
    <div class="card-header">
        <h3 class="card-title">Modification des informations du dépot du {{\Carbon\Carbon::parse($depot->updated_at)->format('d/m/Y')}} de {{ $depot->particulier->name}}</h3>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-1">
            ...
            <div class="col-md-10">
                                                        ...
                                                        <form class="form-horizontal" action="{{ route('depot.depots.update', ['depot' => $depot->id]) }}" method="POST" enctype="multipart/form-data">   
                                                            @method('PATCH')                                    
