                    ...
                    <div class="mt-3">
                        <div style="color:#262626" class="row">
                            <div class="col-md-10 text-left">
                              ...
                              <div class="col">Nom du remettant ...... : {{$depot->name_deposant}} {{$depot->prename_deposant}} </div>
                              <div class="col">Adresse du remettant ...... :  {{$depot->add_deposant}}</div>
                            ...
                            <div class="col-md-2 mt-7">
                              <div class="col">{{$depot->particulier->name}} {{$depot->particulier->prename}}</div>
