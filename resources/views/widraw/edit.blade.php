...
<div class="card col-md-8">
    <div class="card-header">
        <h3 class="card-title">Modification des informations du retrait du {{\Carbon\Carbon::parse($widraw->created_at)->format('d/m/Y')}} de {{ $widraw->sod->society->name}}</h3>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-1">
            ...
            <div class="col-md-10">
                                                        ...
                                                        <form class="form-horizontal" action="{{ route('widraw.widraws.update', ['widraw' => $widraw->id]) }}" method="POST" enctype="multipart/form-data">   
                                                            @method('PATCH')                                    
