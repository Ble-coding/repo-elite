...
@section('page-header')
						...
						<div id="hidden" class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#"><i class="fe fe-file-text mr-2 fs-14"></i>remove</a></li>
               ...
               <div class="row espace">
                 <div class="mt-3 col-md-12">
                    ...
                    <div style="font-size: 16px" class="text-center col-12">
                        <i> BORDEREAU DE RETRAIT ESPECES N° {{$remove->reference}}</i> 
                    </div>
                    <div style="color:#262626" class="text-center mt-3 row">
                        <div class="col-md-6">
                            {{$remove->sode->client->code}}
                        </div>
                        <div class="col-md-6"> 
                    ...
                    <div class="mt-3">
                        <div style="color:#262626" class="row">
                            <div class="col-md-10 text-left">
                              ...
                              <div class="col">Nom du débiteur ...... : {{$remove->name_retirant}} {{$remove->prename_retirant}} </div>
                              <div class="col">Adresse du débiteur ...... :  {{$remove->add_retirant}}</div>
                              <div class="col">Pays de residence ...... : 225 - COTE D'IVOIRE</div>
                              <div class="col">Motif ........... : {{$remove->motif}}</div>
                            </div>
                            {{-- <div class="col-md-2">
                            </div> --}}
                            <div class="col-md-2 mt-7">
                              <div class="col">{{$remove->sode->client->name}} {{$remove->sode->client->prename}}</div>
                              <div class="col">{{$remove->sode->client->address}}  </div>
                            </div>
                        </div> 
                    </div> <br>
                    {{-- 
                    <div class="mt-3">
                        <div style="color:#262626" class="row">
                            ...
                            <div class="col-md-3">
                                <div class="col">{{ number_format($remove->montantR, 0, ',', ' ') }} XOF</div>
                                @if ($remove->timbre == "Oui")
                    ...
                    <div class="mt-3 ">
                        <div style="color:#262626" class="row">
                            ...
                            <div class="col-md-2">
                              {{-- <div class="col">{{ number_format($remove->montantR, 0, ',', ' ') }}</div> --}}
                              <div class="col">{{ number_format($remove->montant, 0, ',', ' ') }}  </div>
                            </div>
                        </div> 
                    </div> <br>
                    ...
                    <div class="mt-3 ">
                        <div style="color:#262626" class="row">
                            <div class="col-md-9 text-left">
                              <div class="col">Nous portons au débit du compte n° <span class="mr-2">{{$remove->sode->client->code}}</span>   XOF :</div>
