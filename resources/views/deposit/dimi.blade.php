               ...
               <div class="row espace">
                 <div class="mt-3 col-md-12">
                    <div style="font-size: 16px" class="text-center col-12">
                        <i> BORDEREAU DE VERSEMENT ESPECES N° {{$deposit->reference}}</i> 
                   </div>
                    <div style="color:#262626" class="text-center mt-3 row">
                        <div class="col-md-6">
                            {{$deposit->entreprise->code}}
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="mt-3 col-md-12">
                        <div style="color:#262626" class="row">
                            <div class="col-md-5">
                              ...
                              <div class="col">Nom du remettant ...... : Mr {{$deposit->name_deposant}} {{$deposit->prename_deposant}} </div>
                              <div class="col">Pays de residence ...... : 225 - COTE D'IVOIRE</div>
                              <div class="col">Motif ........... : {{$deposit->motif}}</div>
                            </div>
                            <div class="col-md-2">
                            </div>
                            <div class="col-md-5 mt-7">
                              <div class="col">Mr/Mme {{$deposit->entreprise->name}} {{$deposit->entreprise->prename}}</div>
                              <div class="col">{{$deposit->entreprise->address}}  </div>
                            </div>
                        </div> 
                    </div> <br>
                    ...
                    <div class="mt-3 col-md-12">
                        <div style="color:#262626" class="row">
                            ...
                            <div class="col-md-3">
                                <div class="col">{{ number_format($deposit->montantR, 0, ',', ' ') }} XOF</div>
                    ...
                    <div class="mt-3 col-md-12">
                        <div style="color:#262626" class="row">
                            ...
                            <div class="col-md-5">
                              <div class="col">{{ number_format($deposit->montantR, 0, ',', ' ') }}</div>
                              <div class="col">{{ number_format($deposit->rendu, 0, ',', ' ') }}  </div>
                            </div>
                        </div> 
                    </div> <br>
                    ...
                    <div class="mt-3 col-md-12">
                        <div style="color:#262626" class="row">
                            <div class="col-md-5">
                              <div class="col">Nous portons au credit du compte n°{{$deposit->entreprise->code}}     XOF :</div>
                              <div class="col">Soit </div>
                            </div>
                            <div class="col-md-2">
                            </div>
                            <div class="col-md-5">
                              <div class="col">{{ number_format($deposit->montantD, 0, ',', ' ') }}</div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-10">
                        ...
                        <form class="form-horizontal" name="MyForm" action="{{ route('deposit.deposits.storeded') }}" method="POST" enctype="multipart/form-data">                                    
                        
                            {{-- @csrf --}}
                            @include('includes.formwithadral')  

                                                                    <div class="jumbotron">
                                                                        {{-- <h1 class="display-3">Salut!</h1> --}}
                                                
                                                   
                                                                            <p class="lead">Vous etes sur le point d'effectuer un retrait de <strong>{{$deposit->entreprise->name}} {{$deposit->entreprise->prename}}</strong> titulaire du 
                                                                                compte <strong>{{$deposit->entreprise->code}} </strong>.
