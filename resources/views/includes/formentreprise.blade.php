...
<div class="form-row">
    <div class="form-group col-md-6 mb-4"> 
        <div class="input-group-prepend">
            ...
            <select name="forme_id" id="forme_id" class="@error('forme_id') is-invalid @enderror form-control custom-select select2">
               ...
               <option value="{{$forme->id}}" {{ $entreprise->forme_id == $forme->id ? 'selected' : '' }}>{{ $forme->name }}</option>
                    @endforeach
            </select> 
            @error('forme_id')
    ...
    <div class="form-group col-md-6 mb-0">
        <div class="input-group mb-4">
            ...
            <input  value="{{ old('name') ?? $entreprise->name }}" class="form-control @error('name') is-invalid @enderror" type="text" placeholder="{{ __('Nom Entreprise') }}" id="name" name="name">
                         @error('name')
                                  <div class="invalid-feedback">
                                                    {{ $errors->first('name') }}
                                 </div>
...
<div class="form-row">
	<div class="form-group col-md-6 mb-0">
        <div class="input-group mb-4">
            <div class="input-group-text">
                ...
                <input  value="{{ old('siege') ?? $entreprise->siege }}" class="form-control @error('siege') is-invalid @enderror" type="text" placeholder="{{ __('Siège de l\'entreprise') }}" id="siege" name="siege">
                             @error('siege')
                                      <div class="invalid-feedback">
                                                        {{ $errors->first('siege') }}
                                     </div>
    ...
    <div class="form-group col-md-6 mb-0">
            <div class="input-group mb-4">
                ...
                <input  value="{{ old('capital') ?? $entreprise->capital }}" class="form-control @error('capital') is-invalid @enderror" type="text" placeholder="{{ __('Capital') }}" id="capital" name="capital">
                             @error('capital')
                                      <div class="invalid-feedback">
...
{{-- <div class="form-row">
		<div class="form-group col-md-6 mb-0">
            <div class="input-group mb-4">
                ...
                <input  value="{{ old('ri') ?? $entreprise->ri }}" class="form-control @error('ri') is-invalid @enderror" type="text" placeholder="{{ __('Regime d\'imposition') }}" id="ri" name="ri">
                             @error('ri')
                                      <div class="invalid-feedback">
                                                        {{ $errors->first('ri') }}
                                     </div>
        ...
        <div class="form-group col-md-6 mb-0">
            <div class="input-group mb-4">
                ...
                <input  value="{{ old('nc') ?? $entreprise->nc }}" class="form-control @error('nc') is-invalid @enderror" type="text" placeholder="{{ __('Numéro du contribuable') }}" id="nc" name="nc">
                             @error('nc')
                                      <div class="invalid-feedback">
                                                        {{ $errors->first('nc') }}
                                     </div>
...
<div class="form-row">
    <div class="form-group col-md-6 mb-4"> 
        <div class="input-group-prepend">
            ...
            <input id="nr" type="text" class="form-control @error('nr') is-invalid @enderror" name="nr" value="{{ old('nr') ?? $entreprise->nr  }}" placeholder="{{ __(' Numéro RCCM') }}" autocomplete="nr" autofocus>
            @error('nr')
                <div class="invalid-feedback">
                                {{ $errors->first('nr') }}
                </div>
    ...
    <div class="form-group col-md-6 mb-0">
        <div class="input-group mb-4">
            ...
            <input id="tel_ent" type="tel" class="form-control @error('tel_ent') is-invalid @enderror" name="tel_ent" value="{{ old('tel_ent') ?? $entreprise->tel_ent  }}"  autocomplete="tel_ent" placeholder="{{ __('Tel entreprise') }}" autofocus>
            @error('tel_ent')
                <div class="invalid-feedback">
        ...
        <div class="form-group m-0">
            ...
            <div class="custom-controls-stacked">
                <label class="custom-control custom-radio">
                    ...
                    @if (old('sexe') ==  'M'
                    || $entreprise->sexe == 'M') checked @endif checked>
                    <span class="custom-control-label">M</span>
                </label>
                <label class="custom-control custom-radio">
                    <input type="radio" class="custom-control-input" name="sexe" 
                    @if (old('sexe') ==  'F'
                    || $entreprise->sexe == 'F') checked @endif value="F">
        ...
        <div class="form-group m-0">
            ...
            <div class="custom-controls-stacked">
                <label class="custom-control custom-radio">
                    ...
                    || $entreprise->situation == 'Celibataire') checked @endif checked>
                ...
                <label class="custom-control custom-radio">
                    ...
                    || $entreprise->situation == 'Marie') checked @endif>
    ...
    <div class="form-group col-md-6 mb-4"> 
        <div class="input-group-prepend">
            ...
            <select name="piece_id" id="piece_id" class="@error('piece_id') is-invalid @enderror form-control custom-select select2">
                ...
                <option value="{{ $piece->id }}" {{  $entreprise->piece_id == $piece->id ? 'selected' :  ''}}>
                    {{ $piece->nom }}</option>
                @endforeach
            </select> 
            @error('piece_id')
