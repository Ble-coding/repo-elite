...
<div class="input-group mb-4">
    ...
    <input id="montant" type="text" class="form-control @error('montant') is-invalid @enderror" name="montant" value="{{ old('montant') ?? $somme->montant  }}"  autocomplete="montant" placeholder="{{ __('Montant du solde') }}" autofocus>
            @error('montant')
                <div class="invalid-feedback">
