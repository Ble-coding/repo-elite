               ...
               <div class="row espace">
                 <div class="mt-3 col-md-12">
                    ...
                    <i> BORDEREAU DE RETRAIT ESPECES N° {{$ref}}</i>
                        {{-- <i> BORDEREAU DE RETRAIT ESPECES N° {{$withadral->reference}}</i>  --}}
                    </div>
                    <div style="color:#262626" class="text-center mt-3 row">
                        <div class="col-md-6">
                            {{$withadral->sold->entreprise->code}}
                        </div>
                        <div class="col-md-6"> 
                    ...
                    <div class="mt-3">
                        <div style="color:#262626" class="row">
                            <div class="col-md-10 text-left">
                              ...
                              <div class="col">Nom du débiteur ...... : {{$withadral->name_retirant}} {{$withadral->prename_retirant}} </div>
                              <div class="col">Adresse du débiteur ...... :  {{$withadral->add_retirant}}</div>
                              <div class="col">Pays de residence ...... : 225 - COTE D'IVOIRE</div>
                              <div class="col">Motif ........... : {{$withadral->motif}}</div>
                            </div>
                            {{-- <div class="col-md-2">
                            </div> --}}
                            <div class="col-md-2 mt-7">
                              <div class="col">{{$withadral->sold->entreprise->name}} {{$withadral->sold->entreprise->prename}}</div>
                              <div class="col">{{$withadral->sold->entreprise->address}}  </div>
                            </div>
                        </div> 
                    </div> <br>
                    {{-- 
                    <div class="mt-3">
                        <div style="color:#262626" class="row">
                            ...
                            <div class="col-md-3">
                                <div class="col">{{ number_format($withadral->montantR, 0, ',', ' ') }} XOF</div>
                                @if ($withadral->timbre == "Oui")
                    ...
                    <div class="mt-3 ">
                        <div style="color:#262626" class="row">
                            ...
                            <div class="col-md-2">
                              {{-- <div class="col">{{ number_format($withadral->montantR, 0, ',', ' ') }}</div> --}}
                              <div class="col">{{ number_format($withadral->montant, 0, ',', ' ') }}  </div>
                            </div>
                        </div> 
                    </div> <br>
                    ...
                    <div class="mt-3 ">
                        <div style="color:#262626" class="row">
                            <div class="col-md-9 text-left">
                              <div class="col">Nous portons au débit du compte n° <span class="mr-2">{{$withadral->sold->entreprise->code}}</span>   XOF :</div>
