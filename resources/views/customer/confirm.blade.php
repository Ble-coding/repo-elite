    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <form class="form-horizontal" action="{{ route('confirmators.storeded') }}" method="POST" enctype="multipart/form-data">                                    
                    ...
                    <div class="jumbotron">
                        <h1 class="display-3">Salut!</h1>
                                ...
                                <p class="lead">Vous etes sur le point de confirmer que le client 
                                    <strong>{{$customer->name}} {{$customer->prename}}</strong>
                        ...
                        @include('includes.formconfirmator')  
                <div class="text-wrap">
