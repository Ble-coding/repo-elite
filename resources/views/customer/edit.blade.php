						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="#">Edit particulier {{ $customer->name}}</a></li>
								</ol>
							</div>
...
<div class="card col-md-8">
    <div class="card-header">
        <h3 class="card-title">Modification des informations du customer {{ $customer->name}}</h3>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-1">
            ...
            <div class="col-md-10">
                                                        ...
                                                        <form class="form-horizontal" action="{{ route('customers.update', ['customer' => $customer->id]) }}" method="POST" enctype="multipart/form-data">   
                                                            @method('PATCH')                                    
                                                                @include('includes.formcustomer')
                                                            <div class="text-wrap">
                    ...
                    <div class="card col-md-10">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    @include('includes.formcustomer1')                   
                                </div>
                                <div class="col-md-1">
