...
@section('content')
						...
						<div class="row">
							<div class="col-xl-3 col-lg-4">
								<div class="card box-widget widget-user">
									...
									@php
											$image = DB::table('customers')->where('id', $customer)->first();
							...
							{{-- 		<span class="avatar brround avatar-md d-block">																				
									...
									<div class="card-body text-center pt-2">
										<div class="pro-user">
											<h3 class="pro-user-username text-dark mb-1 fs-22">{{$customer->name}} {{$customer->prename}}</h3>
											<h6 class="pro-user-desc text-muted">{{$customer->email}}</h6>
											<h6 class="pro-user-desc text-muted">{{$customer->tel}}</h6>
							...
							<div class="col-xl-9 col-lg-8">
								<div class="card">
									<div class="card-header">
										<div class="card-title">Compte {{$customer->code}}</div>
									</div>
									<div class="card-body">
										...
										<div class="row">
											<div class="col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="" disabled class="form-control" placeholder="{{\Carbon\Carbon::parse($customer->datenaiss)->format('d/m/Y')}} à {{$customer->lieu}}">
												</div>
											</div>
											<div class="col-sm-6 col-md-6">
												<div class="form-group">
													<label class="form-label">Numéro de téléphone</label>
													<input type="" disabled class="form-control" placeholder="{{$customer->tel}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Nationnalité</label>
													<input type="" disabled class="form-control" placeholder="{{$customer->nationnalite}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Sexe</label>
													<input type="" disabled class="form-control" placeholder="{{$customer->sexe}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Situation matrimoniale</label>
													<input type="" disabled class="form-control" placeholder="{{$customer->situation}}">
												</div>
											</div>	
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Nom du conjoint</label>
													<input type="" disabled class="form-control" placeholder="{{$customer->successeur_name}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Prénom du conjoint</label>
													<input type="" disabled class="form-control" placeholder="{{$customer->successeur_prename}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Numéro de téléphone</label>
													<input type="" disabled class="form-control" placeholder="{{$customer->successeur_tel}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Nom Personne à contacter</label>
													<input type="" disabled class="form-control" placeholder="{{$customer->personne_name}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Prénom Personne à contacter</label>
													<input type="" disabled class="form-control" placeholder="{{$customer->personne_prename}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Numéro de téléphone</label>
													<input type="" disabled class="form-control" placeholder="{{$customer->personne_tel}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Type pièce</label>
													<input type="" disabled class="form-control" placeholder="{{$customer->piece->nom}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Numéro de pièce</label>
													<input type="" disabled class="form-control" placeholder="{{$customer->numpiece}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Date d'expiration</label>
													<input type="" disabled class="form-control" placeholder="{{\Carbon\Carbon::parse($customer->dateexp)->format('d/m/Y')}}">
												</div>
											</div>																	
									</div>
									{{-- <div class="card-footer text-right">
						...
						<div class="row">
							...
							<div class="col-xl-9 col-lg-8">
								<div class="card">
									<div class="card-header">
										<div class="card-title">{{$customer->prof}}</div>
									</div>
									<div class="card-body">
										{{-- <div class="card-title font-weight-bold">Basci info:</div> --}}
										<div class="row">
											<div class="col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="" disabled class="form-control" placeholder="{{$customer->nom_ent}}">
												</div>
											</div>
											<div class="col-sm-6 col-md-6">
												<div class="form-group">
													<label class="form-label">Adresse</label>
													<input type="" disabled class="form-control" placeholder="{{$customer->address}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Tel Entreprise</label>
													<input type="" disabled class="form-control" placeholder="{{$customer->tel_ent}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Date début de fonction</label>
													<input type="" disabled class="form-control" placeholder="{{$customer->date_deb}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Type de contrat</label>
													<input type="" disabled class="form-control" placeholder="{{$customer->type->name}}">
												</div>
											</div>																										
									</div>
									{{-- <div class="card-footer text-right">
