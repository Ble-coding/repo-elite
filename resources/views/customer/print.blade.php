			...
			<div class="row pt-5">
				...
				<div class=" text-center col-md-12">
					<p style="font-size:18px; text-decoration: underline;font-weight: bold; color: #262626">
                        CONVENTION D’OUVERTURE D’UN COMPTE INVESTISSEMENT
                    </p>
				</div>
				<div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <strong>Numéro du Client  : </strong>{{$customer->tel}}<br>
                                <strong>Numéro du Compte Investissement  : </strong> {{$customer->code}}
                            </div>
                            <div class="col-md-6">
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>ELITE CREDIT consent à son client l’ouverture d’un Compte Investissement à condition que ce dernier s’engage 
                                à en exécuter les conditions définies aux présentes. Le Compte Investissement est 
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Le délai d’ouverture du Compte Investissement est immédiat, 
                                ...
                                <p>A l’ouverture du compte, ELITE CREDIT  remet à son client
                                     ...
                                     le numéro de Compte Investissement, le numéro de la carte d’identité ainsi que sa 
                                     signature. Toute opérations sur le Compte Investissement requiert 
                                 ...
                                 <p>En cas de perte de sa CIC, le client peut demander à <i>ELITE CREDIT</i> de lui remettre une nouvelle
                                      moyennant l’acquittement d’un montant forfaitaire qui sera prélevé de son Compte Investissement.</p>
                         </div> <br>
                        ...
                        <div style="font-size: 15px;" class="">
                            ...
                            <p>Le titulaire n’est redevable d’aucune commission de mouvement sur le compte. 
                                ...
                                chèque impayé au retard de paiement d’une échéance de crédit,
                                 à l’édition d’un relevé de Compte, etc., sont perceptible sur le Compte Investissement.</p>
                         </div> <br> 
...
<br>              <div style="font-size: 15px;" class="">
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Un dépôt minimum est exigé à l’ouverture du Compte Investissement. 
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Tout moment, le compte Investissement doit présenter un solde supérieur au solde minimum exigé.
                               </p>
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Toute opération réalisée sur le compte Investissement  doit respecter le montant minimum d’opération.
...
Toute opération en dessus du montant minimum sera refusée.</p>
                        ...
                        <div style="font-size: 15px;" class="">
                           <p> Les fonds déposés sur un compte Investissement sont disponibles immédiatement,
                            ...
                            Le nombre de retraits autorisés sur un compte Investissement est illimité.</p>
                         </div> <br>
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Le solde d’un compte Investissement ne peut en aucun cas être débité.</p>
                         </div> <br>
                        ...
                        <div style="font-size: 15px;" class="">
                           <p> Le compte Investissement a un taux de rémunération de 3,4% annuel.</p>
                         </div> <br>
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Le titulaire doit désigner sur le Formulaire d’ouverture de compte s’il désire 
                                avoir un consignataire sur son compte Investissement . Le cas échéant, ce dernier dispose 
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Le titulaire d’un Compte Investissement peut désigner un mandataire- et un seul- habilité 
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Le compte Investissement offre une palette de service : retrait en espèces, dépôt en espèces ou par chèque, 
                                virement interne entre Compte de 
                               <strong> ELITE CREDIT</strong>. Le nombre d’opérations autorisées sur un Compte Investissement est illimité.</p>
                                 <p>Le compte Investissement retrace toutes les opérations.
                                      En plus des opérations crédit, 
                                     des dépôts et des retraits, le compte Investissement retrace toutes les opérations des services associés.</p>
                         </div>
 <br><br><br><br><br>
                         <div class="row mt-3">
                            <div style="font-size: 18px; text-decoration: underline" class="col-md-6">
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>
                                Un Compte Investissement peut être approvisionné par la remise d’un chèque à l’ordre de <strong> ELITE CREDIT</strong>. 
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>La clôture d’un Compte Investissement est possible à tout moment sous réserve que le Client s’acquitte des 
                                frais de clôture. 
                            ...
                            <p>Avant de pouvoir procéder à la clôture, tous les frais, pénalités 
                                et commissions dû par le client associé
                                 au compte Investissement doit avoir été remboursé intégralement. </p>
                         </div> <br>
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Un compte Investissement qui reste sans mouvement pendant une période de 6 mois 
                                ...
                                et / ou clôturer un compte déclassé. En cas de solde nul, le compte Investissement sera clôturé automatiquement 
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Nul ne peut effectuer de mouvement sur un Compte Investissement dont le titulaire
                            ...
                            <p>Dès que ELITE <strong>CREDIT</strong> est informé de la date du décès de son client, le compte Investissement est déclassé en compte inactif. 
                                Le compte déclassé ne peut plus enregistrer de mouvement, ni au débit ni au crédit.</p>
                                <p>Au décès du titulaire, le solde disponible sur le compte Investissement sera mis à disposition de son ayant droit,
 ...
 <br>
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Toute opération associée au compte Investissement, effectuée aux guichets de
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Moyennant le paiement d’un montant forfaitaire, <strong>ELITE CREDIT</strong> remet au client qui fait la demande un relevé de son compte Investissement.
                                 ...
                                 Le paiement de ce service se fait par prélèvement automatique sur le compte Investissement du client.
                                </p>
                                <p>
                                    ...
                                    compte Investissement qui lui sont délivrés. 
...
<br><br><br>
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Pour l’exécution de la présente convention d’ouverture de compte Investissement,
                                ...
                                <p>
                                    ...
                                    à l’interprétation et l’exécution de cette convention d’Ouverture de Compte Investissement.
                                    </p>
