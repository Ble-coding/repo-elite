						...
						<div class="col-md-6">  
							<div class="">
								<div class="text-white">
									...
									<h1 class="h3  mb-3 font-weight-bold">Le montant minimum sur le solde client doit être  supérieur
										ou égal à 5000 <h1>
									...
									<a   href="{{route('depot.depots.index')}}" style="background:#FF0017; color:#fff" class="btn btn"><i class="fe fe-arrow-left-circle mr-1"></i>Retour</a>
								</div>
							</div>
