...
<div class="row">
        ...
        <div class="main-content-body main-content-body-profile card">
            <div class="main-profile-body">
                <div class="card-body">
                    ...
                    <h5 class="font-weight-bold">Informations du client {{$particulier->code}}</h5>
                    <div class="main-profile-bio mb-0">
                        <p>  @if ($particulier->sexe == 'M')
                            Mr
                        @else
                            Mme
                        @endif
                        <strong>{{$particulier->name}} {{$particulier->prename}}</strong>, de pays de nationalité {{$particulier->nationnalite}} né(e) le {{\Carbon\Carbon::parse($particulier->datenaiss)->format('d/m/Y')}} à {{$particulier->lieu}}.
                        Titulaire de la pièce d’Immatriculation de type {{$particulier->piece->nom}} N°{{$particulier->numpiece}} expirant le {{\Carbon\Carbon::parse($particulier->dateexp)->format('d/m/Y')}}.
                        @if ( $particulier->situation == 'Celibataire')
 ...
 <p>En cas d'urgence nom et personne à contacter, @if ( $particulier->personne_name !== Null
    ||  $particulier->personne_prename !== Null  || $particulier->personne_tel !== Null)
     {{$particulier->personne_name}} {{$particulier->personne_prename}} {{$particulier->personne_tel}} 
 @else
     (Neant)
 @endif . </p>
                    ...
                    <div class="main-profile-contact-list d-lg-flex">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <div class="font-weight-normal1">
                                    {{$particulier->lieu_habitation}}, Cote d'ivoire
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body border-top">
                    ...
                    <div class="main-profile-contact-list d-lg-flex">
                        <div class="media mr-5">
                            ...
                            <div class="media-body">
                                <h6 class="font-weight-bold mb-1">{{$particulier->prof}} à {{$particulier->nom_ent}}</h6>
                                <span>{{$particulier->date_deb}}- Adresse  {{$particulier->address}}</span>
                                <p>{{$particulier->tel_ent}}</p>
                            </div>
                        </div>
                        <div class="media mr-5">
                            ...
                            <div class="media-body">
                                <h6 class="font-weight-bold mb-1">Type contrat {{$particulier->type->name}} </h6>
                                {{-- <span>2004-2008</span>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <form class="form-horizontal" action="{{ route('confirms.storeded') }}" method="POST" enctype="multipart/form-data">                                    
                    ...
                    <div class="jumbotron">
                        <h1 class="display-3">Salut!</h1>
                                ...
                                <p class="lead">Vous etes sur le point de confirmer que le client 
                                    <strong>{{$particulier->name}} {{$particulier->prename}}</strong>
