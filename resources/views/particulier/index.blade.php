													...
													<div class="e-table">
														<div class="table-responsive table-lg mt-3">
															<table class="table table-bordered border-top text-nowrap" id="example1">
																...
																<tbody>
																	@if(!empty($particuliers) && $particuliers->count())
																	 ...
																	 {{-- @php
																	   ...
																	   @endphp  
																		...
																		<td>{{$particulier->code}}</td>
																		 ...
																		 <td>{{$particulier->email}} <br> {{$particulier->tel}}</td> 
																		 {{-- <td></td>      --}}
																		 {{-- @can('manage-users')
															...
															<table class="table table-bordered border-top text-nowrap" id="example4">
																...
																<tbody>
																	...
																	@endphp  
																		...
																		<form method="POST"  class="d-inline" action="{{route('particuliers.restore' , ['particulier' => $particulier->id]) }}">
																			@csrf
																			@method('PUT')																			
