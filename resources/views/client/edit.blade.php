						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="#">Edit Particulier {{ $client->name}}</a></li>
								</ol>
							</div>
...
<div class="card col-md-8">
    <div class="card-header">
        <h3 class="card-title">Modification des informations du particulier {{ $client->name}}</h3>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-1">
