...
<div class="container p-5">
			...
			<div class="row pt-5">
				...
				<div class=" text-center col-md-12">
					<p style="font-size:18px; text-decoration: underline;font-weight: bold; color: #262626">
                        CONVENTION D’OUVERTURE D’UN COMPTE COURANT
                    </p>
				</div>
				<div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <strong>Numéro du Client  : </strong>{{$client->tel}}<br>
                                <strong>Numéro du Compte Courant   : </strong> {{$client->code}}
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="">
                            <p>ET @if ($client->sexe == 'M')
                                Mr
                            @else
                                Mme
                            @endif <strong> {{$client->name}} {{$client->prename}}</strong> Résident à {{$client->lieu_habitation}},
                                Tel (+225){{$client->tel}}, de pays de nationalité {{$client->nationnalite}}.
                                Homme né(e) le {{\Carbon\Carbon::parse($client->datenaiss)->format('d/m/Y')}} à {{$client->lieu}}.
                                Titulaire de la pièce d’Immatriculation de type {{$client->piece->nom}} N°{{$client->numpiece}} dument habilité aux fins des présentes et de leurs suites </p>
                         </div>
 ...
 <br>
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Le titulaire d’un compte courant est redevable de frais de gestion de compte.</p>
...
<br>              <div style="font-size: 15px;" class="">
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Tout moment, le compte courant  doit présenter un solde supérieur au solde minimum exigé.
                               </p>
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Toute opération réalisée sur le compte courant doit respecter le montant minimum d’opération.</p>
<p>Ce dernier est clairement affiché dans les agences <strong>ELITE ALLIANCE</strong>.
Toute opération en dessus du montant minimum sera refusée.</p>
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Le solde d’un compte courant  ne peut en aucun cas être débité.</p>
                         </div> <br>
                        ...
                        <div style="font-size: 15px;" class="">
                           <p> Le compte courant étant un compte de dépôt a vu ne fit objet d’aucune rémunération.</p>
                         </div> <br>
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>
                                ...
                                Pour faire de face aux frais de retour d’un chèque impayé, un solde minimum doit être maintenu dans le compte avant le dépôt du chèque.
                                 ...
                                 <p>La date de valeur d’un dépôt par chèque dépend du délai
                                      de traitement de la compensation réalisée par la banque partenaire de <strong>ELITE CREDIT</strong>.</p>
                         </div>
                         <br>
                         <div class="row mt-3">
                            <div style="font-size: 18px; text-decoration: underline" class="col-md-6">
 ...
 <br>
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Toute opération associée au compte courant, effectuée aux guichets de
...
<br><br><br>
                        ...
                        <div style="font-size: 15px;" class="">
                            <p>Pour l’exécution de la présente convention d’ouverture de compte courant,
