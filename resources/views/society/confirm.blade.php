                    ...
                    <div class="main-profile-contact-list d-lg-flex">
                        <div class="media mr-5">
                            ...
                            <div class="media-body">
                                ...
                                <p>Chiffres d'affaires annuel {{$society->caa}}</p>
                            </div>
                        </div>
                        <div class="media mr-5">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <form class="form-horizontal" action="{{ route('confirmeres.storeded') }}" method="POST" enctype="multipart/form-data">                                    
