						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="#">Edit Entreprise {{ $society->name}}</a></li>
								</ol>
							</div>
...
<form class="form-horizontal" action="{{ route('societies.update', ['society' => $society->id]) }}" method="POST" enctype="multipart/form-data">   
    @method('PATCH')         
    @csrf
    <div class="row">  
        <div class="col-md-1">
