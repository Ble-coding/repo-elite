               ...
               <div class="row espace">
                 <div class="mt-3 col-md-12">
                    <div style="font-size: 16px" class="text-center col-12">
                        <i> BORDEREAU DE VERSEMENT ESPECES N° {{$depose->reference}}</i> 
                   </div>
                    ...
                    <div class="mt-3 col-md-12">
                        <div style="color:#262626" class="row">
                            <div class="col-md-5">
                              ...
                              <div class="col">Nom du remettant ...... : Mr {{$depose->name_deposant}} {{$depose->prename_deposant}} </div>
                              <div class="col">Pays de residence ...... : 225 - COTE D'IVOIRE</div>
                              <div class="col">Motif ........... : {{$depose->motif}}</div>
                            </div>
                            <div class="col-md-2">
                            </div>
                            <div class="col-md-5 mt-7">
                              <div class="col">Mr/Mme {{$depose->society->name}} {{$depose->society->prename}}</div>
                    ...
                    <div class="mt-3 col-md-12">
                        <div style="color:#262626" class="row">
                            ...
                            <div class="col-md-3">
                                <div class="col">{{ number_format($depose->montantR, 0, ',', ' ') }} XOF</div>
                    ...
                    <div class="mt-3 col-md-12">
                        <div style="color:#262626" class="row">
                            ...
                            <div class="col-md-5">
                              <div class="col">{{ number_format($depose->montantR, 0, ',', ' ') }}</div>
                              <div class="col">{{ number_format($depose->rendu, 0, ',', ' ') }}  </div>
                            </div>
                        </div> 
                    </div> <br>
                    ...
                    <div class="mt-3 col-md-12">
                        <div style="color:#262626" class="row">
                            <div class="col-md-5">
                              <div class="col">Nous portons au credit du compte n°{{$depose->society->code}}     XOF :</div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-10">
                        ...
                        <form class="form-horizontal" name="MyForm" action="{{ route('depose.deposes.storeded') }}" method="POST" enctype="multipart/form-data">                                    
                        
                            {{-- @csrf --}}
                            @include('includes.formwidraw')  

                                                                    <div class="jumbotron">
                                                                        {{-- <h1 class="display-3">Salut!</h1> --}}
                                                
                                                   
                                                                            <p class="lead">Vous etes sur le point d'effectuer un retrait de <strong>{{$depose->society->name}} {{$depose->society->prename}}</strong> titulaire du 
                                                                                compte <strong>{{$depose->society->code}} </strong>.
