                    ...
                    <div class="mt-3">
                        <div style="color:#262626" class="row">
                            <div class="col-md-10 text-left">
                              ...
                              <div class="col">Nom du remettant ...... : {{$depose->name_deposant}} {{$depose->prename_deposant}} </div>
                              <div class="col">Adresse du remettant ...... :  {{$depose->add_deposant}}</div>
                    ...
                    <div class="mt-3 ">
                        <div style="color:#262626" class="row">
                            <div class="col-md-9 text-left">
                              <div class="col">Nous portons au credit du compte n° <span class="mr-2">{{$depose->society->code}}</span>   XOF :</div>
