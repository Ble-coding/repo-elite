...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Compte Investissemnt </h4>
								<ol class="breadcrumb">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <form class="form-horizontal" action="{{ route('diminish.diminishes.store') }}" method="POST" enctype="multipart/form-data">                                    
