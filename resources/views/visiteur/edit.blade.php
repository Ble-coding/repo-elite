						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="#">Edit client {{ $visiteur->client}}</a></li>
								</ol>
							</div>
...
@section('content')
    ...
    <form class="form-horizontal" action="{{ route('elite.visiteur.updated', ['visiteur' => $visiteur->id]) }}" method="POST" enctype="multipart/form-data"> 
        @method('PATCH')  
        @csrf
        <div class="row">
            <div class="col-md-1">
            ...
            <div class="card col-md-10">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            @include('includes.formvisiteur1')                   
                        </div>
                        <div class="col-md-1">
            ...
            <div class="card col-md-10">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            @include('includes.formvisiteur2')                   
                        </div>
                        <div class="col-md-1">
