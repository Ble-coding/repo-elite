						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="#">Edit client {{ $vente->visiteur->code}}</a></li>
								</ol>
							</div>
...
@section('content')
    ...
    <form class="form-horizontal" action="{{ route('elite.elites.update', ['vente' => $vente->id]) }}" method="POST" enctype="multipart/form-data"> 
        @method('PATCH')  
        @csrf
        {{-- <div class="row">
            <div class="col-md-1">
