...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#"><i class="fe fe-file-text mr-2 fs-14"></i>Rachat</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="#">Rachat</a></li>
								</ol>
							</div>
...
<div class="card col-md-10">
    <div class="card-header">
        <h3 class="card-title">Rachat du compte {{$vente->code}} de {{$vente->name}} {{$vente->prename}}</h3>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-1">
            ...
            <div class="col-md-10">
                ...
                <form class="form-horizontal" name="MyForm" action="{{ route('elite.rachats.storeded') }}" method="POST" enctype="multipart/form-data">                                    
                    ...
                    <div class="jumbotron">
                        ...
                        {{-- <h6>Versement</h6> --}}
                            <div style="display:none" >{{$v = ($vente->montant * $bonus) / 100   }}</div>
                                ...
                                <p class="lead">Vous etes sur le point de recevoir la somme de <strong>{{ number_format($v + $vente->montant, 0, ',', ' ') }}</strong> Fcfa de <strong>{{$vente->name}} {{$vente->prename}}</strong> titulaire du 
                        ...
                        <h6>Versement n° {{$v = $vente->duree - $vente->compteur + 1    }}</h6>
                            ...
                            @if ($vente->compteur >= 1)
                            <p class="lead">Vous etes sur le point de recevoir la somme de <strong>{{ number_format($v1, 0, ',', ' ') }}</strong> Fcfa de <strong>{{$vente->name}} {{$vente->prename}}</strong> titulaire du 
                                n°client <strong>{{$vente->code}}</strong>.
