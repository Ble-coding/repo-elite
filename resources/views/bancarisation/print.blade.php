    ...
    <div class="div  position-ref">
            <div class=" content p-5 row">
                <div class="col-12 total mb-6" style="border-color:#262626;background:#fff;">
                    <h1 class="text-black text-center">FORMULAIRE DE DEMANDE DE CREDIT ENTREPRISE</h1>
                    <div class="row">
                    ...
                    <div class="row espace">
                          @include('printing.printpart3')
                    </div>
                </div>
                <div class="col-12 total mt-3 mb-6" style="border-color:#262626;background:#fff;">
                    <h1 class="text-black text-center">FORMULAIRE DE DEMANDE DE CREDIT ENTREPRISE</h1>
                    <div class="row">
                        <div class="col-md-4"></div>
                        <div class="col-md-4 m-2">
                    ...
                    <div class="row espace">
                        @include('printing.printpart4')
                    </div>
                </div>
                <div class="col-12 total mt-9 mb-4" style="border-color:#262626;background:#fff;">
                    <h1 class="text-black text-center">FORMULAIRE DE DEMANDE DE CREDIT ENTREPRISE</h1>
                    <div class="row">
                        <div class="col-md-4"></div>
                        <div class="col-md-4 m-2">
                    ...
                    <div class="row espace">
                        @include('printing.printpart5')
                    </div>
                </div>
                <div class="col-12 total mt-5 mb-5" style="border-color:#262626;background:#fff;">
                    <h1 class="text-black mt-5 text-center">FORMULAIRE DE DEMANDE DE CREDIT ENTREPRISE</h1>
                    <div class="row">
                        <div class="col-md-4"></div>
                        <div class="col-md-4 m-2">
                            {{-- <img src="{{asset('assets/images/brand/ogo.png')}}" alt="logo"> --}}
