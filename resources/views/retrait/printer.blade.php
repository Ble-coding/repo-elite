               ...
               <div class="row espace">
                 <div class="mt-3 col-md-12">
                    ...
                    <div style="font-size: 16px" class="text-center col-12">
                        ...
                        {{-- <i> BORDEREAU DE RETRAIT ESPECES N° {{$retrait->reference}}</i>  --}}
                    </div>
                    <div style="color:#262626" class="text-center mt-3 row">
                        <div class="col-md-6">
                            {{$retrait->solde->particulier->code}}
                        </div>
                        <div class="col-md-6"> 
                    ...
                    <div class="mt-3">
                        <div style="color:#262626" class="row">
                            <div class="col-md-10 text-left">
                              ...
                              <div class="col">Nom du débiteur ...... : {{$retrait->name_retirant}} {{$retrait->prename_retirant}} </div>
                              <div class="col">Adresse du débiteur ...... :  {{$retrait->add_retirant}}</div>
                              <div class="col">Pays de residence ...... : 225 - COTE D'IVOIRE</div>
                              <div class="col">Motif ........... : {{$retrait->motif}}</div>
                            </div>
                            {{-- <div class="col-md-2">
                            </div> --}}
                            <div class="col-md-2 mt-7">
                              <div class="col">{{$retrait->solde->particulier->name}} {{$retrait->solde->particulier->prename}}</div>
                              <div class="col">{{$retrait->solde->particulier->address}}  </div>
                            </div>
                        </div> 
                    </div> <br>
                    {{-- 
                    <div class="mt-3">
                        <div style="color:#262626" class="row">
                            ...
                            <div class="col-md-3">
                                <div class="col">{{ number_format($retrait->montantR, 0, ',', ' ') }} XOF</div>
                                @if ($retrait->timbre == "Oui")
                    ...
                    <div class="mt-3 ">
                        <div style="color:#262626" class="row">
                            ...
                            <div class="col-md-2">
                              {{-- <div class="col">{{ number_format($retrait->montantR, 0, ',', ' ') }}</div> --}}
                              <div class="col">{{ number_format($retrait->montant, 0, ',', ' ') }}  </div>
                            </div>
                        </div> 
                    </div> <br>
                    ...
                    <div class="mt-3 ">
                        <div style="color:#262626" class="row">
                            <div class="col-md-9 text-left">
                              <div class="col">Nous portons au débit du compte n° <span class="mr-2">{{$retrait->solde->particulier->code}}</span>   XOF :</div>
