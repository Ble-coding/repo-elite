...
<div class="card col-md-8">
    <div class="card-header">
        <h3 class="card-title">Modification des informations du retrait du {{\Carbon\Carbon::parse($retrait->updated_at)->format('d/m/Y')}} de {{ $retrait->solde->particulier->name}}</h3>
        {{-- <h3 class="card-title">Modification des informations du retrait du {{\Carbon\Carbon::parse($depot->created_at)->format('d/m/Y')}} de {{ $depot->particulier->name}}</h3> --}}
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-1">
