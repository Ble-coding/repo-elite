...
@section('page-header')
						...
						<div id="hidden" class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#"><i class="fe fe-file-text mr-2 fs-14"></i>Bonus</a></li>
               ...
               <div class="row espace">
                 <div class="mt-3 col-md-12">
                        ...
                        <div style="color:#262626" class="row">
                            ...
                            <div class="col-md-2 mt-7">
                              ...
                              <div class="col">
                                    ...
                                    @if($investi->godfather_id !== Null)
                                     <strong>{{$investi->godfather->address}}</strong>. 
                                    @elseif($investi->intervenant_id !== Null)
                                     <strong>{{$investi->intervenant->address}}</strong>. 
                                    @else
                    ...
                    <div class="mt-3 ">
                        <div style="color:#262626" class="row">
                            <div class="col-md-10 text-left">
                              <div class="col">Montant reçu</div>
                            ...
                            <div class="col-md-2">
                                 <div style="display:none;"> {{ $recup = $investi->montantB * ($bonus/100)}}</div> 
                             <div class="col">{{ number_format($recup, 0, ',', ' ') }}</div>
                             <div class="col">{{ number_format($investi->montantB, 0, ',', ' ') }}</div>
