...
@section('page-header')
						...
						<div  id="hidden" class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#"><i class="fe fe-layers mr-2 fs-14"></i>Investissement</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="#">Show investissement</a></li>
								</ol>
							</div>
...
@section('content')
						...
						<div class="row">
							<div class="col-xl-3 col-lg-4">
								<div class="card box-widget widget-user">
									...
									@php
											$image = DB::table('particuliers')->where('id', $particulier)->first();
							...
							<div class="col-xl-9 col-lg-8">
								<div class="card">
									<div class="card-header">
										<div class="card-title">Compte {{$particulier->code}}</div>
									</div>
									<div class="card-body">
										...
										<div class="row">
											<div class="col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="" disabled class="form-control" placeholder="{{\Carbon\Carbon::parse($particulier->datenaiss)->format('d/m/Y')}} à {{$particulier->lieu}}">
												</div>
											</div>
											<div class="col-sm-6 col-md-6">
												<div class="form-group">
													<label class="form-label">Numéro de téléphone</label>
													<input type="" disabled class="form-control" placeholder="{{$particulier->tel}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Nationnalité</label>
													<input type="" disabled class="form-control" placeholder="{{$particulier->nationnalite}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Sexe</label>
													<input type="" disabled class="form-control" placeholder="{{$particulier->sexe}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Situation matrimoniale</label>
													<input type="" disabled class="form-control" placeholder="{{$particulier->situation}}">
												</div>
											</div>	
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Nom du conjoint</label>
													<input type="" disabled class="form-control" placeholder="{{$particulier->successeur_name}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Prénom du conjoint</label>
													<input type="" disabled class="form-control" placeholder="{{$particulier->successeur_prename}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Numéro de téléphone</label>
													<input type="" disabled class="form-control" placeholder="{{$particulier->successeur_tel}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Nom Personne à contacter</label>
													<input type="" disabled class="form-control" placeholder="{{$particulier->personne_name}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Prénom Personne à contacter</label>
													<input type="" disabled class="form-control" placeholder="{{$particulier->personne_prename}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Numéro de téléphone</label>
													<input type="" disabled class="form-control" placeholder="{{$particulier->personne_tel}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Type pièce</label>
													<input type="" disabled class="form-control" placeholder="{{$particulier->piece->nom}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Numéro de pièce</label>
													<input type="" disabled class="form-control" placeholder="{{$particulier->numpiece}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Date d'expiration</label>
													<input type="" disabled class="form-control" placeholder="{{\Carbon\Carbon::parse($particulier->dateexp)->format('d/m/Y')}}">
												</div>
											</div>																	
									</div>
									{{-- <div class="card-footer text-right">
						...
						<div class="row">
							...
							<div class="col-xl-9 col-lg-8">
								<div class="card">
									<div class="card-header">
										<div class="card-title">{{$particulier->prof}}</div>
									</div>
									<div class="card-body">
										{{-- <div class="card-title font-weight-bold">Basci info:</div> --}}
										<div class="row">
											<div class="col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="" disabled class="form-control" placeholder="{{$particulier->nom_ent}}">
												</div>
											</div>
											<div class="col-sm-6 col-md-6">
												<div class="form-group">
													<label class="form-label">Adresse</label>
													<input type="" disabled class="form-control" placeholder="{{$particulier->address}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Tel Entreprise</label>
													<input type="" disabled class="form-control" placeholder="{{$particulier->tel_ent}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Date début de fonction</label>
													<input type="" disabled class="form-control" placeholder="{{$particulier->date_deb}}">
												</div>
											</div>
											<div class="col-sm-4 col-md-4">
												<div class="form-group">
													<label class="form-label">Type de contrat</label>
													<input type="" disabled class="form-control" placeholder="{{$particulier->type->name}}">
												</div>
											</div>																										
									</div>
									{{-- <div class="card-footer text-right">
