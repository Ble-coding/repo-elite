               ...
               <div class="row espace">
                 <div class="mt-3 col-md-12">
                    <div style="font-size: 16px" class="text-center col-12">
                        <i> BORDEREAU DE VERSEMENT ESPECES N° {{$depositary->reference}}</i> 
                   </div>
                    <div style="color:#262626" class="text-center mt-3 row">
                        <div class="col-md-6">
                            {{$depositary->client->code}}
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="mt-3 col-md-12">
                        <div style="color:#262626" class="row">
                            <div class="col-md-5">
                              ...
                              <div class="col">Nom du remettant ...... : Mr {{$depositary->name_deposant}} {{$depositary->prename_deposant}} </div>
                              <div class="col">Pays de residence ...... : 225 - COTE D'IVOIRE</div>
                              <div class="col">Motif ........... : {{$depositary->motif}}</div>
                            </div>
                            <div class="col-md-2">
                            </div>
                            <div class="col-md-5 mt-7">
                              <div class="col">Mr/Mme {{$depositary->client->name}} {{$depositary->client->prename}}</div>
                              <div class="col">{{$depositary->client->address}}  </div>
                            </div>
                        </div> 
                    </div> <br>
                    ...
                    <div class="mt-3 col-md-12">
                        <div style="color:#262626" class="row">
                            ...
                            <div class="col-md-3">
                                <div class="col">{{ number_format($depositary->montantR, 0, ',', ' ') }} XOF</div>
                    ...
                    <div class="mt-3 col-md-12">
                        <div style="color:#262626" class="row">
                            ...
                            <div class="col-md-5">
                              <div class="col">{{ number_format($depositary->montantR, 0, ',', ' ') }}</div>
                              <div class="col">{{ number_format($depositary->rendu, 0, ',', ' ') }}  </div>
                            </div>
                        </div> 
                    </div> <br>
                    ...
                    <div class="mt-3 col-md-12">
                        <div style="color:#262626" class="row">
                            <div class="col-md-5">
                              <div class="col">Nous portons au credit du compte n°{{$depositary->client->code}}     XOF :</div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-10">
                        ...
                        <form class="form-horizontal" name="MyForm" action="{{ route('depositary.depositarys.storeded') }}" method="POST" enctype="multipart/form-data">                                    
                            ...
                            @include('includes.formremove')  
                                                                    ...
                                                                    <div class="jumbotron">
                                                                        {{-- <h1 class="display-3">Salut!</h1> --}}
                                                                            ...
                                                                            <p class="lead">Vous etes sur le point d'effectuer un retrait de <strong>{{$depositary->client->name}} {{$depositary->client->prename}}</strong> titulaire du 
                                                                                compte <strong>{{$depositary->client->code}} </strong>.
