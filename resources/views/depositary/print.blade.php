                    ...
                    <div class="mt-3">
                        <div style="color:#262626" class="row">
                            <div class="col-md-10 text-left">
                              ...
                              <div class="col">Nom du remettant ...... : {{$depositary->name_deposant}} {{$depositary->prename_deposant}} </div>
                              <div class="col">Adresse du remettant ...... :  {{$depositary->add_deposant}}</div>
                            ...
                            <div class="col-md-2 mt-7">
                              <div class="col">{{$depositary->client->name}} {{$depositary->client->prename}}</div>
                    ...
                    <div class="mt-3 ">
                        <div style="color:#262626" class="row">
                            <div class="col-md-9 text-left">
                              <div class="col">Nous portons au credit du compte n° <span class="mr-2">{{$depositary->client->code}}</span>   XOF :</div>
