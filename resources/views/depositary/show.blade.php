...
@section('page-header')
						...
						<div  id="hidden" class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Compte Courants Particulier</h4>
								<ol class="breadcrumb">
							...
							<div class="col-xl-3 col-lg-4">
								<div class="card box-widget widget-user">
									...
									<div class="card-body text-center pt-2">
										<div class="pro-user">
											<h3 class="pro-user-username text-dark mb-1 fs-22">{{$depositary->particulier->name}}</h3>
											<h6 class="pro-user-desc text-muted">{{$depositary->particulier->tel}}</h6>
										</div>
									</div>
								</div>
							...
							<div class="col-xl-9 col-lg-8">
								<div class="card">
									<div class="card-header">
										<div class="card-title">Epargne particulier numéro {{$depositary->id}} du {{\Carbon\Carbon::parse($depositary->updated_at)->format('d/m/Y')}}</div>
									</div>
									<div class="card-body">
										...
										<div class="row">
											<div class="col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="" disabled class="form-control" placeholder="{{$depositary->montant}}">
												</div>
											</div>
											<div class="col-sm-6 col-md-6">
												<div class="form-group">
