...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Valeur</h4>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#"><i class="fe fe-file-text mr-2 fs-14"></i>Données</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="#">Valeur</a></li>
								</ol>
							</div>
...
{{-- <form class="form-horizontal" action="{{ route('parrains.update') }}" method="POST" enctype="multipart/form-data">  --}}
    <form class="form-horizontal" action="{{ route('valeurs.update', ['valeur' => $valeur->id]) }}" method="POST" enctype="multipart/form-data"> 
    @csrf
    @method('PATCH')
    <div class="row">
        <div class="col-md-1">
        ...
        <div class="card col-md-10">
                <div class="card-header">
                    <h3 class="card-title">Valeur de rachat</h3>
                </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-1">
                    ...
                    <div class="col-md-10">
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input id="pourcentage" type="number" class="form-control @error('pourcentage') is-invalid @enderror" name="pourcentage" value="{{ old('pourcentage') ?? $valeur->pourcentage}}" autocomplete="pourcentage" autofocus placeholder="{{ __('Valeur') }}">
                                    @error('pourcentage')
                                        <div class="invalid-feedback">
                                                        {{ $errors->first('pourcentage') }}
                                    </div>
                                    @enderror
                                </div>
                    </div>
