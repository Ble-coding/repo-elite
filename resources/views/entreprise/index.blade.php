	...
	<div class="tab-menu-heading">
		<div class="tabs-menu ">
			...
			<ul class="nav panel-tabs">
				<li class=""><a href="#tab1" class="active" data-toggle="tab">Entreprises</a></li>
				@can('manage-users')
					<li><a href="#tab2" data-toggle="tab">Supprimées</a></li>	
				@endcan						
			</ul>
		</div>
	</div>
															   ...
															   @endphp  
																...
																<td>{{$entreprise->code}}</td>  
																 ...
																 <td>
																	...
																	<a href="{{ route('entreprises.show' , ['entreprise' => $entreprise->id]) }}" style="background-color:#fff" class="btn btn-">👀</a>
